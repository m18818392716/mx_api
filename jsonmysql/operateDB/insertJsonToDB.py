#-*- coding:utf-8 -*-
# @Time    : 2019/4/4 上午11:46
# @Author  : Susanna Chen
# @Site    : 
# @File    : insertJsonToDB.py
# @Software: PyCharm
...
def reviewdata_insert(db):
  with open('../jsonFiles/review.json', encoding='utf-8') as f:
    i = 0
    while i<= 7:
      i += 1
      print(u'正在载入第%s行......' % i)
      try:
        ...
        print('review_text is: %s' % review_text)
        # result = []
...
if __name__ == "__main__": # 起到一个初始化或者调用函数的作用
  ...
  db = pymysql.connect("localhost", "root", "123456789", "testDjango2", charset='utf8')
  cursor = db.cursor()
  prem(db)
